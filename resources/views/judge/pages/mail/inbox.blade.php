				...
				<div class="col email-options ps-container">
					<div class="padding-15">
						<div class="butt-container">
							<a href="compose" class="btn btn-primary btn-block btn-rounded">Compose</a>
						</div>
						<ul class="main-options">
							<li class="activeli">
								<a href="inbox">
									<span class="title"> &nbsp; Inbox</span>
									<span class="label label-pill label-success pull-xs-right badge-green">10</span>
								</a>	
							</li>
							<li>
								<a href="inbox">
							...
							<li>
								<a href="inbox">
									...
									<span class="label label-pill label-danger pull-xs-right badge-red">16</span>
								</a>	
							</li>
							<li>
								<a href="">
				...
				<div class="wrap-message">	
					<div class="n0-scroll">
						...
						<div class="message-sender">
							<img class="img-circle sender-img m-r-xs" src="images/flat-avatar.png" alt=""> 
