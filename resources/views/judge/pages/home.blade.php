...
@section('section')
	<div class="row">
		<div class="col-md-12 col-lg-3">
			<div class="home-stats">
				@include('judge.widgets.stats',array('icon'=>'cloud-upload','value'=>'88','bgclass'=>'info', 'link'=>'c3chart', 'progress-value'=>'88','text'=> Lang::get(\Session::get('lang').'.stat1')))
				@include('judge.widgets.stats',array('icon'=>'heartbeat','value'=>'94','bgclass'=>'success', 'link'=>'c3chart', 'progress-value'=>'88','text'=>Lang::get(\Session::get('lang').'.stat2')))
				@include('judge.widgets.stats',array('icon'=>'flag','value'=>'88','bgclass'=>'danger', 'link'=>'inbox', 'progress-value'=>'94','text'=>Lang::get(\Session::get('lang').'.stat3')))		
			</div>
		</div>
				...
				<div class="bottom-right-chart">
					<div class="top-left-chart clearfix">
						<div class="row">
							...
							<div class="col-sm-6">
								<div id="pie"  style="height:125px; padding-top:5px;margin-bottom: 4px;"></div>
							</div>
						</div>
					</div>	
				</div>
	...
	<div class="row">
		...
		<div class="col-lg-4 col-md-6">
			<div class="todo-container card card-inverse">
				<div class="card-header card-danger text-xs-center">
						...
						<div class="todo-list-wrap">
							<ul class="todo-list">
								<li class="">
									...
									<span>Meeting with Nabindar Singh.</span>
								</li>
								<li class="">
									...
									<span>Exercise at 6:pm with Nicholas.</span>
								</li>
								<li class="">
								...
								<li class="">
									...
									<span>Henna birthday at Mezbaan.</span>
								</li>
								<li class="">
